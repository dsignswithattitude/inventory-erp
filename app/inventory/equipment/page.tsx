...
import { Plus, AlertTriangle, CheckCircle, Clock, Lock, Calendar } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-0">
          <Table>
            <TableHeader><TableRow className="hover:bg-transparent">
              ...
              <TableHead>Letzte Prüfung</TableHead><TableHead>Sperre</TableHead>
        ...
        <div className="border-t px-4 py-3"><Pagination currentPage={currentPage} totalPages={totalPages} totalItems={equipment.length} pageSize={pageSize} onPageChange={setCurrentPage} /></div>
      </Card>
    </div>
  );
}
